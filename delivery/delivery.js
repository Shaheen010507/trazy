...
import { getFirestore, doc, collection, updateDoc, onSnapshot, query, where, getDocs } from "https://www.gstatic.com/firebasejs/12.0.0/firebase-firestore.js";
...
function loadDeliveryDetails(uid){
  ...
  onSnapshot(ordersQuery, async snap => {
    ...
    for (const docu of snap.docs) {
      ...
      // Proper way: Query users collection by email
      const usersQuery = query(collection(db, "users"), where("email", "==", order.customerEmail));
